...
export const THEME_COLORS: Record<ThemeColor, { primary: string; gradientMid: string; gradientEnd: string; lightBg: string }> = {
    purple: { primary: '262 60% 50%', gradientMid: '280 65% 60%', gradientEnd: '330 81% 60%', lightBg: 'linear-gradient(135deg, #7c3aed, #a855f7)' },
    blue: { primary: '217 91% 60%', gradientMid: '200 80% 55%', gradientEnd: '217 91% 65%', lightBg: 'linear-gradient(135deg, #3b82f6, #60a5fa)' },
    green: { primary: '160 84% 39%', gradientMid: '160 70% 45%', gradientEnd: '142 76% 46%', lightBg: 'linear-gradient(135deg, #10b981, #34d399)' },
    orange: { primary: '25 95% 53%', gradientMid: '25 90% 55%', gradientEnd: '38 92% 50%', lightBg: 'linear-gradient(135deg, #f97316, #fb923c)' },
    pink: { primary: '330 81% 60%', gradientMid: '330 75% 65%', gradientEnd: '340 82% 52%', lightBg: 'linear-gradient(135deg, #ec4899, #f472b6)' },
